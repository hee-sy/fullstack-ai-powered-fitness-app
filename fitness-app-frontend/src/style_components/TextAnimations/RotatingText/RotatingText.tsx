...
import { motion, AnimatePresence, type Transition, type VariantLabels, type Target, type animationControls, type TargetAndTransition } from "motion/react";
                ...
                <span key={wordIndex} className={cn("inline-flex", splitLevelClassName)}>
                  {wordObj.characters.map((char, charIndex) => (
                    <motion.span
                      key={charIndex}
                      initial={initial}
                      animate={typeof animate === "function" ? undefined : animate}
                      exit={exit}
                      transition={{
                        ...transition,
